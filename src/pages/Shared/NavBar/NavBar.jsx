...
function NavBar() {
    ...
    const links = <>
        ...
        {
            user && <li className="text-white hover:text-orange-600 font-semibold dark:text-gray-300">
                        ...
                        <div className="dropdown  dropdown-end z-50">
                            ...
                            >
                                ...
                                <li className="mt-3">
                                    ...
                                    {roleUser === 'citizen' &&
                                        <NavLink to={"/dashboard/citizenprofile"}>
                                            <FaUser /> Profile
                                        </NavLink>
                                    }
                                    {roleUser === 'staff' &&
                                ...
                                <li >
                                    <NavLink to="/dashboard">
                                        <LucidePackageCheck size={16} /> Dashboard
                                    </NavLink>
                                </li>
                                <li>
                                    <button
